...
import 'package:theatre_tickets_app/controllers/input_validators.dart';
import 'package:theatre_tickets_app/utils/mytheme.dart';
import 'package:theatre_tickets_app/utils/social_buttons.dart';
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      ...
                      style: TextStyle(
                        fontSize: 16,
                        color: const Color.fromARGB(255, 90, 4, 45),
                    ...
                    Padding(
                      ...
                      child: SocialLoginButtons(onAppleClick: () {}, onGoogleClick: () {}, Function: () {  }, children: [], ),
                    ),
                  ],
                ),
              ),
