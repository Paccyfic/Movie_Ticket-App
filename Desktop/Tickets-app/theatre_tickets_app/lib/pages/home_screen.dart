...
import 'package:theatre_tickets_app/controllers/location_controller.dart';
import 'package:theatre_tickets_app/controllers/shared_pref.dart';
import 'package:theatre_tickets_app/pages/profile_screen.dart';
import 'package:theatre_tickets_app/pages/select_location_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(statusBarColor: const Color.fromARGB(255, 90, 4, 45)));
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        child: const Text(
                          "View All",
                          style: TextStyle(color: const Color.fromARGB(255, 90, 4, 45)),
                        ),
                      ),
                    ],
                  ),
