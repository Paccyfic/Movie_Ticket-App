import 'package:theatre_tickets_app/model/seat_layout_model.dart';
...
List<MovieModel> movies = [
  MovieModel(
    ...
    like: 89,
    bannerUrl: "assets/movies/movie6.jpg",
  ),
  MovieModel(
    title: "Fallout",
    description: "description",
  ...
  MovieModel(
    ...
    actors: ["actor a", "actor b"],
    like: 84,
    bannerUrl: "assets/movies/movie9.png",
  ),
];
...
List<TheatreModel> theatres = [
  TheatreModel(id: "1", name: "Century Cinema A/C 2K Dolby"),
  TheatreModel(id: "2", name: "Kigali Universe - Chic mall"),
  TheatreModel(id: "3", name: "Canal Olympia - 4K Dolby Atoms"),
  TheatreModel(id: "4", name: "The One theatres - 4K"),
];
...
final seatLayout = SeatLayoutModel(
    ...
    cols: 11,
    seatTypes: [
      {"title": "King", "price": 20.0, "status": "Filling Fast"},
      {"title": "Queen", "price": 10.0, "status": "Available"},
      {"title": "Jack", "price": 8.0, "status": "Available"},
    ],
    theatreId: 123,
    gap: 2,
    gapColIndex: 5,
