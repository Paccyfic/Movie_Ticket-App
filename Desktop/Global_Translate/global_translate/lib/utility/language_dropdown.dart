  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: const Color.fromARGB(255, 25, 31, 34).withOpacity(0.8),
          width: 0.1,
        ),
      ),
      child: DropdownButton<String>(
        ...
        icon: Padding(
          ...
          child: Icon(
            ...
            color: const Color.fromARGB(255, 25, 31, 34).withOpacity(0.3),
          ),
        ),
        underline: Container(
                ...
                Text(
                  ...
                  style: GoogleFonts.poppins(
                    ...
                    color: selectedCountry == country['countryLanguage']
                        ...
                        : const Color.fromARGB(255, 25, 31, 34).withOpacity(0.8),
                  ),
                ),
              ],
            ),
